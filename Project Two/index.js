...
{'food':
  ...
  'activities':
  {
    'root glen': {'adventure':9, 'fitness':5, 'fun':5},
    'gym': {'adventure':2, 'fitness':10, 'fun':4},
    'sadove': {'adventure':1, 'fitness':3, 'fun':9},
    'wall climbing': {'adventure':3, 'fitness':7, 'fun':7},
  },
  'study':
  {
    'burke': {'quiet':7,'IT':8, 'comfort':8},
    'Kj lobby': {'quiet':5,'IT':7, 'comfort':7},
    'science center': {'quiet':6,'IT':8, 'comfort':6},
    'opus cafe': {'quiet':4,'IT':4, 'comfort':7}
  }
